<?php
/*
	Plugin Name:    Externals - Feed Personalizer
	Plugin URI:     http://en.michaeluno.jp/externals
	Description:    Displays personalized feeds with the Externals plugin.
 ...
 * @since       1
 */
class ExternalsFeedPersonalizer_Registry_Base {
 
	const VERSION        = '0.0.1';    // <--- DON'T FORGET TO CHANGE THIS AS WELL!!
	const NAME           = 'Externals - Feed Personalizer';
 ...
 * @since		1
*/
final class ExternalsFeedPersonalizer_Registry extends ExternalsFeedPersonalizer_Registry_Base {
    
	const TEXT_DOMAIN               = 'externals-feed-personalizer';
     ...
     */    
	const HOOK_SLUG                 = 'efp';    // without trailing underscore
    ...
    static public $aOptionKeys = array(
        'setting'           => 'externals_feed_personalizer',
    );
    ...
    /**
     * Stores used user meta keys.
     *
     * @var array
     */
    static public $aUserMetas = array(
        '_efp_removed_items' => '_efp_removed_items',
    );
...
ExternalsFeedPersonalizer_Registry::setUp( __FILE__ );
...
include( dirname( __FILE__ ).'/include/class/ExternalsFeedPersonalizer_Bootstrap.php' );
new ExternalsFeedPersonalizer_Bootstrap(
    ExternalsFeedPersonalizer_Registry::$sFilePath,
    ExternalsFeedPersonalizer_Registry::HOOK_SLUG    // hook prefix
);